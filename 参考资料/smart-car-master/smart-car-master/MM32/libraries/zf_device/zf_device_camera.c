    ...
    switch(camera_type)
    {
        ...
        case CAMERA_BIN_UART:                                                   // UART 小钻风
            ...
            dma_init_camera(                                                    // 摄像头 DMA 关联初始化
                ...
                image_size,                                                     // 图像大小
                (uint32_t)OV7725_DATA_ADD,                                      // 指定数据输入的外设地址
                (uint32_t)&ov7725_image_binary[0][0]);                          // 指定数据存放首地址
        ...
        case CAMERA_GRAYSCALE:                                                  // 总钻风
            ...
            dma_init_camera(                                                    // 摄像头 DMA 关联初始化
                ...
                image_size,                                                     // 图像大小
                (uint32_t)MT9V03X_DATA_ADD,                                     // 指定数据输入的外设地址
                (uint32_t)&mt9v03x_image[0][0]);                                // 指定数据存放首地址
        ...
        case CAMERA_COLOR:                                                      // 凌瞳
            ...
            dma_init_camera(                                                    // 摄像头 DMA 关联初始化
                ...
                image_size,                                                     // 图像大小
                (uint32_t)SCC8660_DATA_ADD,                                     // 指定数据输入的外设地址
                (uint32_t)&scc8660_image[0][0]);                                // 指定数据存放首地址
