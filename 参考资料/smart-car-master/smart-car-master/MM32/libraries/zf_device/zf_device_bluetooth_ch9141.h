...
#define BLUETOOTH_CH9141_TX_PIN             UART6_RX_C7                         // 蓝牙模块 1 对应模块的 TX 要接到单片机的 RX
#define BLUETOOTH_CH9141_RX_PIN             UART6_TX_C6                         // 蓝牙模块 1 对应模块的 RX 要接到单片机的 TX
#define BLUETOOTH_CH9141_RTS_PIN            C13                                 // 蓝牙模块 1 对应模块的 RTS 引脚
