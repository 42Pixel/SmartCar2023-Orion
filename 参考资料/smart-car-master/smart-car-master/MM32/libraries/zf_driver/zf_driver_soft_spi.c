...
// @return      uint16          读取的数据
//-------------------------------------------------------------------------------------------------------------------
uint16 soft_spi_16bit_data_handler (soft_spi_info_struct *soft_spi_obj, const uint16 data)
{
    uint8 temp = 8;
...
// @param       data            发送的数据
// @return      void
// Sample usage:                soft_spi_16bit_data_handler(&soft_spi_obj,1);
//-------------------------------------------------------------------------------------------------------------------
...
// @param       data            发送的数据
// @return      uint8           返回读取的 8bit 数据
// Sample usage:                soft_spi_read_8bit_register(&soft_spi_obj,0x01);
//-------------------------------------------------------------------------------------------------------------------
