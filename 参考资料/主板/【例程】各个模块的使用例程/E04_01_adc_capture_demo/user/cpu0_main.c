...
#define ADC_CHANNEL7            (ADC1_CH0_A16)
#define ADC_CHANNEL8            (ADC1_CH1_A17)
...
int core0_main(void)
{
    ...
    adc_init(ADC_CHANNEL7, ADC_12BIT);                                          // 初始化对应 ADC 通道为对应精度
    adc_init(ADC_CHANNEL8, ADC_12BIT);                                          // 初始化对应 ADC 通道为对应精度
