...
void    ips200_show_char                (uint16 x, uint16 y, const char dat);                                                  // IPS200 显示字符
...
void    ips200_show_float               (uint16 x, uint16 y, const float dat, uint8 num, uint8 pointnum);                      // IPS200 显示浮点数 (去除整数部分无效的0)
