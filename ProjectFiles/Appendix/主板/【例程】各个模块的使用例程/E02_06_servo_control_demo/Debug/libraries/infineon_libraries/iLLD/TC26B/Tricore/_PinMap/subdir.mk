...
libraries/infineon_libraries/iLLD/TC26B/Tricore/_PinMap/%.src: ../libraries/infineon_libraries/iLLD/TC26B/Tricore/_PinMap/%.c libraries/infineon_libraries/iLLD/TC26B/Tricore/_PinMap/subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc26xb "-fE:/Project/23智能车参考资料/主板/【例程】各个模块的使用例程/E02_06_servo_control_demo/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<" && \
