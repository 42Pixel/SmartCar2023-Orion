...
libraries/infineon_libraries/iLLD/TC26B/Tricore/I2c/I2c/%.src: ../libraries/infineon_libraries/iLLD/TC26B/Tricore/I2c/I2c/%.c libraries/infineon_libraries/iLLD/TC26B/Tricore/I2c/I2c/subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc26xb "-fE:/Git-Files/Fastest-Car/参考资料/无刷电机/TC264_GTM_BLDC_Project-master/【例程】控制无刷电机的示例/E02_05_bldc_contro_demo/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<" && \
