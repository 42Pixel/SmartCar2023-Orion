...
clean-code:
	-$(RM) ./code/IMU.d ./code/IMU.o ./code/IMU.src ./code/Key.d ./code/Key.o ./code/Key.src ./code/Motor_Ctrl.d ./code/Motor_Ctrl.o ./code/Motor_Ctrl.src ./code/Run.d ./code/Run.o ./code/Run.src ./code/UI.d ./code/UI.o ./code/UI.src ./code/VOFA.d ./code/VOFA.o ./code/VOFA.src
