...
libraries/infineon_libraries/Service/CpuGeneric/SysSe/Time/%.src: ../libraries/infineon_libraries/Service/CpuGeneric/SysSe/Time/%.c libraries/infineon_libraries/Service/CpuGeneric/SysSe/Time/subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc26xb "-fE:/Git-Files/Fastest-Car/ProjectFiles/Software/Seekfree_TC264_Opensource_Library/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<" && \
