...
libraries/infineon_libraries/iLLD/TC26B/Tricore/Src/Std/%.src: ../libraries/infineon_libraries/iLLD/TC26B/Tricore/Src/Std/%.c libraries/infineon_libraries/iLLD/TC26B/Tricore/Src/Std/subdir.mk
	...
	cctc -D__CPU__=tc26xb "-fE:/Git-Files/Fastest-Car/²Î¿¼×ÊÁÏ/TC264_Library-master/TC264_Library-master/Seekfree_TC264_Opensource_Library/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -o "$@"  "$<"  -cs --dep-file="$(@:.src=.d)" --misrac-version=2012 -N0 -Z0 -Y0 2>&1;
